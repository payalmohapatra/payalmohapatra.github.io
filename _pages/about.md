...
Hello! I am Payal (<span onclick="document.getElementById('nameAudio').play();" style="cursor: pointer;" title="Hear pronunciation">hear pronounciation📢</span>
<audio id="nameAudio" src="https://github.com/payalmohapatra/payalmohapatra.github.io/blob/master/files/name_pronounce.mp3"></audio>). I am a fourth-year PhD candidate in Computer Engineering at Northwestern University, part of the [IDEAS Lab](http://zhulab.eecs.northwestern.edu/) and advised by [Dr. Qi Zhu](http://eecs.northwestern.edu/~qzhu/). 
